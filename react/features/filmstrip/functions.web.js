...
export function calculateThumbnailSizeForTileView({
    ...
    const topBottomPadding = 4; // was initially 200 then 10, now 4

    // Minimum space to keep between the sides of the tiles and the sides
    // of the window.
    const sideMargins = 4; // was initailly 30 * 2, then 10, now 4
    const verticalMargins = visibleRows * 2; // was initially visibleRows * 10
